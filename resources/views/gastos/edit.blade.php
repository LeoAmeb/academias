                        ...
                        <form method="post" action="{{ route('alumnos.update', $alumno) }}" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group{{ $errors->has('grado') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="grado" id="input-grado" class="form-control form-control-alternative{{ $errors->has('grado') ? ' is-invalid' : '' }}" placeholder="{{ __('Grado') }}" value="{{ old('grado') }}" required>
                                ...
                                <div class="form-group{{ $errors->has('gpo') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="gpo" id="input-gpo" class="form-control form-control-alternative{{ $errors->has('gpo') ? ' is-invalid' : '' }}" placeholder="{{ __('Grupo') }}" value="{{ old('gpo') }}" required>
